...
description: Find deepening opportunities and run architecture-level sanitation sweeps in this project, informed by domain language in docs/CONTEXT.md and decisions in docs/adr/ when present.
---
