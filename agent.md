...
Canonical agent rules for this project. Keep the rule body mirrored across `docs/AIdocs/airules.mdc`, `.cursor/rules/ai-agent-rule.mdc/airulesVS.instructions.md`, `docs/AIdocs/copilot-instructions.md`, `.github/copilot-instructions.md`, and `agent.md`.

## Orientation

- Project overview: `readme.md`
- Repo router skill: `.agent/skills/webgamedev-gram/SKILL.md`
...
- Repo-local skills under `.agent/skills/` are authoritative for this project.
- When a repo-local skill overlaps with a plugin-provided skill, use the repo-local skill.
- Do not use generic plugin workflows such as Game Studio or default Superpowers when `.agent/skills/webgamedev-gram/SKILL.md` routes to a local specialist instead.
...
- For version history, follow `docs/versionlog.md` and `.agent/skills/webgamedev-gram/SKILL.md`: versionlog updates happen after commits exist and claims must be tied to verified evidence.
...
Use `.agent/skills/webgamedev-gram/SKILL.md` for the full routing matrix. In short:

- Bugs, regressions, and failing tests: `.agent/skills/superpowers/systematic-debugging/SKILL.md`
- React and TypeScript implementation: `.agent/skills/best-practices/js-ts-best-practices/SKILL.md`
- React performance or render behavior: `.agent/skills/best-practices/react-best-practices/SKILL.md`
- ShadCN/Radix UI work: `.agent/skills/best-practices/shadcn-best-practices/SKILL.md`
- Supabase/Postgres work: `.agent/skills/best-practices/supabase-best-practices/SKILL.md`
- Completion claims: `.agent/skills/superpowers/verification-before-completion/SKILL.md`
